    ...
    def main():
        ...
        class node: #creating a class called node. In order to register node as a "spot"
            def _innit_(self,row,collum,width,total_rows):
                self.row = row
                self.col = collum
                self.x = row * width
                self.y = collum * width
